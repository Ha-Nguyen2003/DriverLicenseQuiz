...
<main class="container py-5">
    ...
    <!-- Search form -->
    <form method="get" action="${pageContext.request.contextPath}/student-quiz-list">
        <div class="mb-3">
    ...
    <ul class="list-group mt-3">
        <c:forEach var="quiz" items="${quizzes}">
            <li class="list-group-item">
                <a href="${pageContext.request.contextPath}/take-quiz?quizID=${quiz.quizID}">
                    ${quiz.quizName} ( ${quiz.teacherName})
                </a>
            </li>
        </c:forEach>
    </ul>
